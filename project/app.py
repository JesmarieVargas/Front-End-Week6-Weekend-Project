...
def add_customer():
    ...
    try:
        ...
        query = "INSERT INTO Customers (customer_name, email, phone) VALUES (%s, %s, %s)"
...
def update_customer(id):
    ...
    try:
        ...
        query = "UPDATE Customers SET customer_name = %s, email = %s, phone = %s WHERE id = %s"
